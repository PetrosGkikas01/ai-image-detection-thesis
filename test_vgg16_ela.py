...
if __name__ == "__main__":
    ...
    model = get_vgg16_ela_model().to(device)
    model.load_state_dict(torch.load("vgg16_ela_best_model.pth", map_location=device))
    model.eval()

    y_true, y_pred = [], []
    print(f"Testing VGG16-ELA σε {len(test_data)} εικόνες...")
    ...
    print("-" * 30)
    print("ΑΠΟΤΕΛΕΣΜΑΤΑ TESTING (VGG16-ELA):")
